...
sealed class NavRoute(val path: String) {
    ...
    object Main : NavRoute("main?userName={userName}&email={email}")
    ...
    object Profile: NavRoute("profile?userName={userName}&email={email}")
    ...
    object savedReminder: NavRoute("savedReminder/{medName}/{dosage}/{timings}")
